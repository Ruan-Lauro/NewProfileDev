...
import macbookModel from '../../assets/models/macbook-transformed.glb'
import performanceTexture from '../../assets/performance/performance5.png'

export function Macbook(props) {
  const { nodes, materials } = useGLTF(macbookModel);

  const texture = useTexture(performanceTexture);
